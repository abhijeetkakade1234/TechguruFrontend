    ...
    <section className="mb-24 reveal" data-purpose="event-gallery">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 h-auto md:h-[800px]">
        ...
        <div className="md:col-span-4 flex flex-col gap-6">
          <div className="flex-1 p-8 rounded-3xl flex flex-col justify-end bg-[#111]">
            <h2 className="text-4xl font-bold mb-4 text-white leading-tight">
              The TechGuru<br />Experience
            </h2>
            <p className="text-zinc-500 mb-8 text-sm leading-relaxed">{content.gallery.description}</p>
          </div>
          <div className="h-[450px] relative rounded-3xl overflow-hidden group">
            ...
            <div className="absolute bottom-6 left-6">
              <span className="bg-black/70 backdrop-blur px-4 py-2 rounded-full text-[10px] font-bold tracking-widest uppercase text-white border border-white/10 shadow-sm">
        ...
        <div className="md:col-span-3 flex flex-col gap-6">
          ...
          <button className="w-full py-5 rounded-full border border-white/10 text-white font-bold hover:bg-white hover:text-black transition-all shadow-sm cursor-pointer tracking-tight">
            See More Events
          </button>
        </div>
      </div>
